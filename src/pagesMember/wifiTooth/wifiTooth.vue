  ...
  <view class="box-bg">
    <view class="box-bg">
      <uni-nav-bar dark color="#999" backgroundColor="#f5f5f5" shadow left-icon="left" leftText="返回" rightText="设置"
        title="网络接入" @clickLeft="goBack" fixed />
    </view>
  </view>
  <view class="before" v-if="flag">
    <view class="later">
      <uni-section title="请输入Wifi账号密码" sub-title="" type="circle" padding>
        <view class="input" style="flex-direction: column;">
          <uni-easyinput class="uni-mt-5" trim="all" placeholder="Wifi账号"/>
          <uni-easyinput class="uni-mt-5" trim="all" placeholder="Wifi密码"/>
          <view @tap="wifi">添加</view>
        </view>
